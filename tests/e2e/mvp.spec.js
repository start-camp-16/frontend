...
async function mockApi(page) {
  ...
  await page.route('**/api/chat', route => route.fulfill({ json: { answer: '문화비축기지를 추천해요.', sources: [{ type: 'location', content_id: '1', title: '문화비축기지', category: '문화시설', district: '마포구', address: '서울 마포구' }, { type: 'post', post_id: 1, title: '마포 산책 후기', district: '마포구', prefix: '자유' }] } }));
}
